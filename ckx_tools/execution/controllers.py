...
from ckx_tools.common import disable_wide_log
from ckx_tools.common import format_time_delta
from ckx_tools.common import format_time_delta_short
from ckx_tools.common import remove_ansi_escape
from ckx_tools.common import terminal_width
from ckx_tools.common import wide_log

from ckx_tools.notifications import notify

from ckx_tools.terminal_color import fmt
from ckx_tools.terminal_color import sanitize
from ckx_tools.terminal_color import ColorMapper

from ckx_tools.execution import job_server
...
class ConsoleStatusController(threading.Thread):
    ...
    def print_compact_summary(self, completed_jobs, warned_jobs, failed_jobs):
        ...
        if self.show_notifications:
            if len(failed_jobs) != 0:
                notify(notification_title, "\n".join(notification_msg), icon_image='ckx_icon_red.png')
            elif len(warned_jobs) != 0:
                notify(notification_title, "\n".join(notification_msg), icon_image='ckx_icon_yellow.png')
            else:
